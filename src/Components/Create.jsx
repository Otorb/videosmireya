...
const Create = () => {
  ...
  const [category, setCategory] = useState("Seleccione Categoria");
    ...
    uploadTask.on(
      ...
      () => {
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
          ...
          setLoading(false);
          setAlert(true);
          setAlertStatus("listo");
          setAlertIcon(<IoCheckmark fontSize={25} />);
          setAlertMsg("estamos subiendo el video ten calma");
          setTimeout(() => {
            setAlert(false);
          }, 4000);
        });
  ...
  const deleteImage = () => {
    ...
    deleteObject(deleteRef)
      .then(() => {
        ...
        setAlertMsg("su video sera eliminado");
        setTimeout(() => {
          setAlert(false);
        }, 4000);
      })
  ...
  const uploadDetails = async () => {
    try {
      ...
      if (!title && !category && !videoAsset) {
        ...
        setAlertStatus("error");
        setAlertIcon(<IoWarning fontSize={25} />);
        setAlertMsg("es requerido los campos");
        setTimeout(() => {
          setAlert(false);
        }, 4000);
        setLoading(false);
          ...
          {!videoAsset ? (
            <FormLabel width="full">
              ...
              >
                ...
                >
                  {loading ? (
                    <Spinner msg={"subiendo el video"} progress={progress} />
                  ) : (
                    <>
                      <IoCloudUpload
                        fontSize={30}
